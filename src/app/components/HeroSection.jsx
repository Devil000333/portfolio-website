        ...
        <section className="lg:py-16"> 
            <div className="grid grid-cols-1 lg:grid-cols-12">
                <motion.div 
                    ...
                    <div>
                        <Link 
                            href="https://www.linkedin.com/in/dhanraj-nandurkar-611018236/"
                        ...
                        <Link
                            href="https://drive.google.com/drive/folders/1L0rdd51rF3ThrEhmU6CdAghQYVHHV_tZ?usp=sharing"
                            className="px-1 inline-block py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 hover:bg-slate-800 text-white border border-white mt-3"
                            >
